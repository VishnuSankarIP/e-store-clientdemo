...
// import NewLogo from "../../assets/png/looilogored.png";
...
//             <div className="w-[50px] h-[35px] pointer-events-none sm:w-[40px] sm:h-[30px] lg:w-[120px] lg:h-[79px] ">
...
export default function Logo({ width, height, color }) {
  return (
    <div className="relative ml-[3rem] ">
      <div className="w-[100px] h-[89px] pointer-events-none sm:w-[40px] sm:h-[30px] lg:w-[120px] lg:h-[100px]">
      <img 
      src={NewLogo} 
      alt="header-logo" 
    ...
    />
      ...
      {/* Uncomment this part if you need the SVG */}
      {/* <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          className="absolute top-[9px] left-[5px] sm:top-[15px] sm:left-[11px] lg:top-[25px] lg:left-[17px]"
          width={width ? width : "16"} height={height ? height : "16"} viewBox="0 0 23.000000 16.000000"
          preserveAspectRatio="xMidYMid meet">
